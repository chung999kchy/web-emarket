<%-- 
    ...
    Created on : Aug 14, 2020, 6:38:15 PM
    Author     : CHUNG
--%>
...
<div id="container">
    <div class="one-half">
        ...
        <c:if test="${!empty orderFailureFlag}">
            <p style="color: #c00; font-style: italic">We are unable to process your order. Please try again!</p>
        </c:if>
        <form id=""checkoutForm" action="<c:url value='purchase' />" method="post">
            ...
            <fieldset>
                ...
                <input type="text" size="45px" name="address" id="address" value="${param.address}" />
            </fieldset>
            <fieldset>
                <label>City<span clas="required">*</span></label>
                <input type="text" size="45px" name="cityRegion" id="cityRegion" value="${param.cityRegion}" />
            </fieldset>
            <fieldset>
                <label>Credit Card Number<span class="required">*</span></label>
                <input type="text" size="45px" name="creditcard" id="creditcard" value="${param.creditcard}" />
            </fieldset>
            <fieldset>
    ...
    <div class="one-half last">
        ...
        <table>
            ...
            <tr>
                ...
                <td>
                    <fmt:formatNumber type="currency" currencySymbol="&dollar; " value="${initParam.deliveryFee}" />
                </td>
                <td>
                    <fmt:formatNumber type="currency" currencySymbol="&dollar; " value="${cart.total}" />
                </td>
            </tr>
        </table>
    </div>
